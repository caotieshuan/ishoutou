<?php
// 全局设置
class MCommonAction extends GCommonAction
{
	var $glo=NULL;
	var $uid=0;
	//上传参数
	...
	public function _initialize(){
		if(!ListMobile()){
			...
			}else if('on' == $_SERVER['HTTPS'] && 'index' == ACTION_NAME){
	...
	protected function _Upload(){
		...
		$upload->savePath =  C('MEMBER_UPLOAD_DIR').'Idcard/'?C('MEMBER_UPLOAD_DIR').'Idcard/':C('MEMBER_MAX_UPLOAD');// 设置附件上传目录
	...
	//上传图片END
	//会员登录
	protected function _memberlogin($uid,$loginType=''){
