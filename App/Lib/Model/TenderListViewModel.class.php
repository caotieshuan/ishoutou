...
class TenderListViewModel extends ViewModel
{
    public $viewFields = array(
        ...
        'Borrow' => array('id' => 'borrowid', 'borrow_name', 'borrow_duration', 'borrow_money', 'borrow_interest', 'borrow_interest_rate',
            ...
            'is_huinong', 'updata', '_on' => 'Borrow.id=BorrowInvestor.borrow_id', '_type' => 'LEFT'),
        ...
        'InvestorDetail' => array('status'=>'status_detail', 'deadline' => 'times', '_on' => 'InvestorDetail.borrow_id=Borrow.id'),
    );
}
