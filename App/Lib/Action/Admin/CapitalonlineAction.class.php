...
class CapitalonlineAction extends ACommonAction
{
    ...
    */
    public function charge()
    {
        ...
        //$this->assign("way", array('off'=>'ATM/汇款充值','alipay'=>'支付宝转账','llpay'=>'连连支付','gfb'=>'国付宝','ips'=>'环迅支付','chinabank'=>'网银在线','baofoo'=>'宝付','tenpay'=>'财付通','ecpss'=>'汇潮支付','easypay'=>'易生支付','cmpay'=>'中国移动支付'));
		$this->assign("way", array('off'=>'ATM/汇款充值','llpay'=>'连连支付','ecpss'=>'汇潮支付','chinabank'=>'京东支付'));
...
*/		
		...
		foreach($list as $v){
				...
				$row[$i]['card_8'] =($v['withdraw_status']==3)?0:($v['withdraw_money']-$v['withdraw_fee']);
